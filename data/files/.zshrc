...
plugins=(zsh-autosuggestions zsh-completions fast-syntax-highlighting git deno nvm node brew docker gh heroku pipenv rust yarn cargo cp github npm osx pip pm2 pyenv python vundle) 
...
POWERLEVEL9K_CONTEXT_TEMPLATE='UwUssimo'
